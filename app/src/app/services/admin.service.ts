...
export class AdminService {
  ...
  public editUser(user: any): Observable<void> {
    return this.http.post<void>(`${this.api_url}/admin/users/${user._id}`, {
      user
    });
  }
  ...
  public editRole(role: Role): Observable<void> {
    return this.http.post<void>(`${this.api_url}/admin/roles/${role._id}`, {
      role
    });
  }
  ...
  public getLog(id: string): Observable<any> {
    return this.http.get(`${this.api_url}/admin/logs/${id}`, {
